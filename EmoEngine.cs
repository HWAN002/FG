...
namespace Emotiv
{
    ...
    public class OptimizationParam
    {
        ...
        /// <returns>returns a list of vital algorithm composed of IEE_FacialExpressionAlgo_t, IEE_MentalCommandAction_t depending on the suite parameter</returns>
        ...
        /// </summary>
        /// <param name="suite">suite that you are interested in</param>
        /// <param name="vitalAlgorithmBitVector">a list of vital algorithm composed of IEE_FacialExpressionAlgo_t, IEE_MentalCommandAction_t depended on the suite parameter passed in</param>
    ...
    public class EmoEngine
    {
        ...
        /// </summary>
        /// <param name="userId">user ID</param>
        /// <param name="suite">detection suite (FacialExpression or MentalCommand)</param>
